...
static const char normbgcolor[]     = "#2f2f2f";
...
/* tagging */
static const char tags[][MAXTAGLEN] = { "www", "term", "chat", "email", ">_<" };
static unsigned int tagset[] = {1, 1}; /* after start, first tag is selected */

static Rule rules[] = {
	/* class              instance    title       tags mask     isfloating */
	{ "Claws-mail",       NULL,       NULL,       1 << 3,       False },
	{ "Firefox",          NULL,       NULL,       1 << 0,       False },
	{ "URxvt",            NULL,       "irc",      1 << 2,       False }, /* IRC client */
};
...
static const char *irccmd[]  = { "irc", NULL };
